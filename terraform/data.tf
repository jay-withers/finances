...
# The connection string the app and the digest job report telemetry to. Read
# from the shared resource rather than passed in as a variable, so it cannot
# drift from what the platform actually deployed.
